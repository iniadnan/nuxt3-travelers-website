        ...
        <div class="container-travelers pb-[90px] md:pb-[100px] lg:pb-[120px] px-5 md:px-5 lg:px-0">
            <div class="flex flex-wrap lg:flex-nowrap items-start justify-between">
                ...
                <div class="md:max-w-[203px] w-full flex flex-wrap items-start">
                    <article class="md:mb-10 w-1/2 md:w-full">
                        <h2
                            ...
                            Book travel</h2>
                        <h3 class="font-medium text-base md:text-base lg:text-lg text-[#8A8A8A]">We provide the best
                            travel services for you</h3>
                        <a href="/" class="flex items-center gap-x-[23px] mt-[18px] md:mt-[22px] lg:mt-[28px]">
                            <span class="font-medium text-lg md:text-lg lg:text-2xl"
                                style="background: linear-gradient(180deg, #0077ED -112.22%, #7BF9D3 196.67%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Details</span>
                            <svg class="h-[32px] md:h-[32px] lg:h-[36px] xl:h-[40px] w-[32px] md:w-[32px] lg:w-[36px] xl:w-[40px]"
                    ...
                    <article class="w-1/2 md:w-full">
                        <h2
                            class="font-medium text-[32px] md:text-[32px] lg:text-[38px] xl:text-[40px] text-[#1E1E1E] mb-[10px] md:mb-[13px]">
                            Book hotel</h2>
                        <h3 class="font-medium text-base md:text-base lg:text-lg text-[#8A8A8A]">We provide hotel
                ...
                <div class="max-w-[553px] w-full relative my-12 md:my-0">
                    <img class="mx-auto max-w-[460px] w-full h-auto rounded-[20px]"
                        src="/images/book-travel.webp" height="423" width="460" alt="Book Travel">
                    <div class="w-full flex items-center justify-between absolute bottom-5">
                        <div>
                            <div class="booking__label w-[140px] md:w-[182px] flex items-center gap-x-2 md:gap-x-2 lg:gap-x-2.5 py-[5px] pl-[7px] pr-[19px] bg-[#E5F0F5] rounded-[10px] mb-[13px]"
                                ...
                                <span
                                    class="font-medium text-[13px] md:text-[16px] lg:text-[20px] text-[#1E1E1E]">Destinations</span>
                            </div>
                            <div class="booking__label w-[140px] md:w-[182px] flex items-center gap-x-2 md:gap-x-2 lg:gap-x-2.5 py-[5px] pl-[7px] pr-[19px] bg-[#E5F0F5] rounded-[10px]"
                                style="--animation-order: 1;">
                                <svg class="h-[32px] md:h-[32px] lg:h-[36px] xl:h-[40px] w-[32px] md:w-[32px] lg:w-[36px] xl:w-[40px]"
                                    width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span
                                    class="font-medium text-[13px] md:text-[16px] lg:text-[20px] text-[#1E1E1E]">Date</span>
                            </div>
                        </div>
                        <div>
                            <div class="booking__label w-[140px] md:w-[182px] flex items-center gap-x-2 md:gap-x-2 lg:gap-x-2.5 py-[5px] pl-[7px] pr-[19px] bg-[#E5F0F5] rounded-[10px] mb-[13px]"
                                ...
                                <span
                                    class="font-medium text-[13px] md:text-[16px] lg:text-[20px] text-[#1E1E1E]">Location</span>
                            </div>
                            <div class="booking__label w-[140px] md:w-[182px] flex items-center gap-x-2 md:gap-x-2 lg:gap-x-2.5 py-[5px] pl-[7px] pr-[19px] bg-[#E5F0F5] rounded-[10px]"
                                ...
                                <span
                                    class="font-medium text-[13px] md:text-[16px] lg:text-[20px] text-[#1E1E1E]">Prices</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="md:max-w-[203px] w-full flex flex-wrap items-start">
                    <article class="md:mb-10 w-1/2 md:w-full">
                        <h2
                            class="font-medium text-[32px] md:text-[32px] lg:text-[38px] xl:text-[40px] text-[#1E1E1E] mb-[10px] md:mb-[13px]">
                            Book car</h2>
                        <h3 class="font-medium text-base md:text-base lg:text-lg text-[#8A8A8A]">We provide car service
                            for your trip</h3>
                        <a href="/" class="flex items-center gap-x-[23px] mt-[18px] md:mt-[22px] lg:mt-[28px]">
                            <span class="font-medium text-lg md:text-lg lg:text-2xl"
                                style="background: linear-gradient(180deg, #0077ED -112.22%, #7BF9D3 196.67%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Details</span>
                    ...
                    <article class="w-1/2 md:w-full">
                        <h2
                            class="font-medium text-[32px] md:text-[32px] lg:text-[38px] xl:text-[40px] text-[#1E1E1E] mb-[10px] md:mb-[13px]">
                            Others</h2>
                        <h3 class="font-medium text-base md:text-base lg:text-lg text-[#8A8A8A]">We provide various
                            other services</h3>
                        <a href="/" class="flex items-center gap-x-[23px] mt-[18px] md:mt-[22px] lg:mt-[28px]">
                            <span class="font-medium text-lg md:text-lg lg:text-2xl"
                                style="background: linear-gradient(180deg, #0077ED -112.22%, #7BF9D3 196.67%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Details</span>
                ...
                <div class="text-center">
                    ...
                    <div class="h-[100px] md:h-[55px] overflow-hidden">
                        <h2
                            ...
                            Get up to date<br class="block md:hidden" /> notifications
                            from us</h2>
                    </div>
