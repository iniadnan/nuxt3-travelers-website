...
<template>
    ...
    <div class="h-screen w-full flex flex-nowrap relative overflow-hidden">
      ...
      <div class="header-right h-full relative">
        ...
        >
          <!-- TEXT -->
          <svg
            class="w-[120px] md:w-[140px] lg:w-[157px]"
            width="157"
            height="437"
            viewBox="0 0 157 437"
            fill="none"
          ...
          >
            ...
            />
            <path
              d="M82.2029 109.278L80.6053 106.799L92.4504 99.1654L94.048 101.644L82.2029 109.278Z"
              fill="white"
            />
            <path
            ...
            />
            <path
              d="M85.2997 302.962L86.8147 300.431L98.9051 307.67L97.3901 310.2L85.2997 302.962Z"
              fill="white"
            />
            <path
          ...
          <!-- 1M IMAGE -->
          <svg
            class="w-[140px] md:w-[150px] lg:w-[175px] absolute top-1/2 transform -translate-y-1/2 -left-[70px] md:-left-[75px] lg:-left-[87.5px] z-10"
            width="175"
            height="175"
            viewBox="0 0 175 175"
            fill="none"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_12_206"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_12_206"
                  result="shape"
                />
              </filter>
              <linearGradient
                id="paint0_linear_12_206"
                x1="87.5"
                y1="-93.3222"
                x2="87.5"
                y2="243.367"
      ...
      <!-- TEXT -->
      <section
        class="absolute top-[35%] md:top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2"
      >
      ...
      <!-- BOX BOTTOM -->
      <div
        class="max-w-full md:w-auto w-full absolute bottom-0 md:bottom-10 left-0 md:left-1/2 transform md:-translate-x-1/2 z-20 max-w-full absolute bottom-0 md:bottom-10 left-0 md:left-1/2 transform md:-translate-x-1/2 z-20"
      >
        <div
          class="flex items-center py-[16px] md:py-[20px] px-[20px] md:px-[25px] bg-white md:rounded-[15px]"
        >
          <div class="mr-4 md:mr-8 lg:mr-10 xl:mr-16">
            <button
              type="button"
              class="flex items-center gap-x-1 md:gap-x-2 text-[14px] md:text-[16px] lg:text-[20px] text-[#1E1E1E] mb-1 md:mb-1.5"
            >
              <span>Location</span>
              <svg
                class="w-[18px] h-[19px] md:w-[22px] md:h-[23px] lg:w-[24px] lg:h-[25px]"
                width="24"
                height="25"
                viewBox="0 0 24 25"
                fill="none"
            ...
            <p
              class="font-medium text-xs md:text-base text-[#8A8A8A] lg:whitespace-nowrap"
            >
              Indonesia
            </p>
          </div>
          ...
          <div
            class="relative w-auto md:w-[280px] lg:w-[300px] xl:w-[365px] h-[55px] bg-[#E5F0F5] ml-auto flex items-center rounded-[10px] pl-2 md:pl-0 pr-2"
          >
            <input
              class="w-full h-full hidden md:block pl-5 md:pr-[36px] lg:pr-[50px] focus:outline-none text-[#1E1E1E] bg-transparent :placeholder-[#8A8A8A] text-sm md:text-base"
              type="text"
              name="search"
              id="search"
  ...
  <section>
    <div
      class="container-travelers pt-[25px] pb-8 md:pb-10 lg:pb-[55px] px-5 md:px-5 lg:px-0"
    >
      <!-- SPONSOR LIST -->
      <div class="flex items-center">
        <div class="w-1/4">
          <img
            class="h-auto w-full"
            src="/images/sponsor-expedia.png"
            height="100"
            width="100"
            alt="expedia"
          />
        ...
        <div class="w-1/4">
          <img
            class="h-auto w-full"
            src="/images/sponsor-skyscanner.png"
            height="100"
            width="100"
            alt="skyscanner"
          />
        ...
        <div class="w-1/4">
          <img
            class="h-auto w-full"
            src="/images/sponsor-turkish.png"
            height="100"
            width="100"
            alt="turkish"
          />
        ...
        <div class="w-1/4">
          <img
            class="h-auto w-full"
            src="/images/sponsor-sunexpress.png"
            height="100"
            width="100"
            alt="sunexpress"
          />
  ...
  <main>
    <div class="container-travelers px-5 md:px-5 lg:px-0">
      <section class="flex items-center justify-between mb-8 md:mb-10 lg:mb-12">
        <div class="max-w-2/3">
          <h2
            class="font-medium text-[32px] md:text-[32px] lg:text-[36px] xl:text-[40px] text-[#1E1E1E]"
          >
            Popular destinations
          </h2>
        </div>
        ...
        <div class="flex items-center gap-x-3 md:gap-x-5">
          <button
            type="button"
            class="popular-destination-swiper-button-prev h-8 w-8 md:h-10 md:w-10 rounded-full inline-flex items-center justify-center"
            aria-label="Button Swiper Left"
            style="background-color: rgba(229, 240, 245, 1)"
          >
            <svg
              width="24"
              height="24"
          ...
          <button
            type="button"
            class="popular-destination-swiper-button-next h-8 w-8 md:h-10 md:w-10 rounded-full inline-flex items-center justify-center"
    ...
    >
      <div class="flex flex-wrap items-start justify-between">
        ...
        <div class="order-2 md:order-1 md:max-w-[529px] w-full">
          ...
          <p
            class="font-medium text-[19px] md:text-[19px] lg:text-[21.48px] text-[#8A8A8A]"
          >
          ...
          >
            ...
            >
              ...
              <span
                class="font-medium text-base md:text-[18px] lg:text-[20px] text-[#1E1E1E]"
                >Hotel</span
              >
            </div>
            <div
            ...
            <a href="/" class="h-[45px]" aria-label="Learn More">
              ...
              >
                ...
                <rect
                  ...
                  height="43"
                  rx="9"
                  stroke="url(#paint1_linear_12_310)"
                  stroke-width="2"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_12_310"
                    x1="77"
                    y1="-8.32222"
                    x2="77"
                    y2="50.3667"
        ...
        <div
          class="order-1 md:order-2 md:max-w-[400px] w-full relative mb-8 md:mb-0"
        >
          <img
  ...
  <main>
    ...
    >
      <div class="flex flex-wrap lg:flex-nowrap items-start justify-between">
        <!-- BOOKING TRAVEL LEFT -->
        <div class="md:max-w-[203px] w-full flex flex-wrap items-start">
          <article class="md:mb-10 w-1/2 md:w-full">
            <h2
              class="font-medium text-[32px] md:text-[32px] lg:text-[38px] xl:text-[40px] text-[#1E1E1E] mb-[10px] md:mb-[13px]"
            >
              Book travel
            </h2>
            <h3
              class="font-medium text-base md:text-base lg:text-lg text-[#8A8A8A]"
            >
              We provide the best travel services for you
            </h3>
            <a
              href="/"
              class="flex items-center gap-x-[23px] mt-[18px] md:mt-[22px] lg:mt-[28px]"
            >
              <span
                class="font-medium text-lg md:text-lg lg:text-2xl"
                style="
                  background: linear-gradient(
                    180deg,
                    #0077ed -112.22%,
              ...
              >
              <svg
                class="h-[32px] md:h-[32px] lg:h-[36px] xl:h-[40px] w-[32px] md:w-[32px] lg:w-[36px] xl:w-[40px]"
                width="40"
                height="40"
                viewBox="0 0 40 40"
                fill="none"
          ...
          <article class="w-1/2 md:w-full">
            ...
            <h3
              class="font-medium text-base md:text-base lg:text-lg text-[#8A8A8A]"
            >
              We provide hotel services for you to rest
            </h3>
            <a
              href="/"
              class="flex items-center gap-x-[23px] mt-[18px] md:mt-[22px] lg:mt-[28px]"
        ...
        <div class="max-w-[553px] w-full relative my-12 md:my-0">
          <img
            class="mx-auto max-w-[460px] w-full h-auto rounded-[20px]"
            src="/images/book-travel.webp"
            height="423"
            width="460"
            alt="Book Travel"
          />
          <div
            class="w-full flex items-center justify-between absolute bottom-5"
          >
            <div>
              <div
                class="booking__label w-[140px] md:w-[182px] flex items-center gap-x-2 md:gap-x-2 lg:gap-x-2.5 py-[5px] pl-[7px] pr-[19px] bg-[#E5F0F5] rounded-[10px] mb-[13px]"
                style="--animation-order: 1"
              >
                <svg
                  class="h-[32px] md:h-[32px] lg:h-[36px] xl:h-[40px] w-[32px] md:w-[32px] lg:w-[36px] xl:w-[40px]"
                ...
                <span
                  class="font-medium text-[13px] md:text-[16px] lg:text-[20px] text-[#1E1E1E]"
                  >Destinations</span
                >
              </div>
              <div
                class="booking__label w-[140px] md:w-[182px] flex items-center gap-x-2 md:gap-x-2 lg:gap-x-2.5 py-[5px] pl-[7px] pr-[19px] bg-[#E5F0F5] rounded-[10px]"
                style="--animation-order: 1"
              >
                <svg
                  class="h-[32px] md:h-[32px] lg:h-[36px] xl:h-[40px] w-[32px] md:w-[32px] lg:w-[36px] xl:w-[40px]"
        ...
        <div class="md:max-w-[203px] w-full flex flex-wrap items-start">
          <article class="md:mb-10 w-1/2 md:w-full">
            ...
            <h3
              class="font-medium text-base md:text-base lg:text-lg text-[#8A8A8A]"
            >
              We provide car service for your trip
            </h3>
            <a
              href="/"
              class="flex items-center gap-x-[23px] mt-[18px] md:mt-[22px] lg:mt-[28px]"
          ...
          <article class="w-1/2 md:w-full">
            ...
            <h3
              class="font-medium text-base md:text-base lg:text-lg text-[#8A8A8A]"
            >
              We provide various other services
            </h3>
            <a
              href="/"
              class="flex items-center gap-x-[23px] mt-[18px] md:mt-[22px] lg:mt-[28px]"
    ...
    >
      <div class="flex flex-wrap items-start justify-between">
        ...
        <div class="w-full md:max-w-[449px]">
          <div class="relative">
            <div class="border-8 border-[#E5F0F5] rounded-full">
              <img
                class="rounded-full object-cover w-full max-w-[449px]"
            ...
            <img
              ...
              src="/svgs/reviews-emoticon.svg"
              height="65"
              width="65"
              alt="Emoticon"
            />
            <img
              class="absolute bottom-16 right-0 z-10"
              src="/svgs/reviews-like.svg"
              height="65"
              width="65"
              alt="Like"
            />
        ...
        <div class="w-full md:max-w-[460px] mt-8 md:mt-0">
          <h2
            class="font-medium text-[36px] md:text-[34px] lg:text-[40px] text-[#1E1E1E] mb-6 md:mb-10"
          >
            Reviews
          </h2>
          <h3
            class="font-medium text-xl md:text-lg lg:text-2xl text-[#8A8A8A] mb-6 md:mb-10"
          >
          ...
          <div class="flex items-center gap-x-5 md:gap-x-6 lg:gap-x-10">
            <div>
              <div class="mb-3.5 md:mb-5">
                <img
                  class="w-[80px] md:w-[90px] lg:h-[100px] w-[72px] md:w-[80px] lg:w-[100px] object-cover rounded-full border-4 border-[#E5F0F5]"
                  src="/images/reviews-1.webp"
                  height="100"
                  width="100"
                  alt="Ruhi Bors"
              ...
              <h4
                class="font-medium text-lg md:text-lg lg:text-2xl text-[#1E1E1E]"
              >
                Ruhi Bors
              </h4>
            </div>
  ...
  <section id="notification">
    ...
    >
      <div
        ...
        class="flex items-center justify-center bg-cover bg-center h-[380px] md:h-[420px] lg:h-[450px] rounded-[20px]"
        style="background-image: url('/images/notifications.webp')"
      >
        <div class="text-center">
          ...
          <form
            method="POST"
            class="h-[50px] w-[276px] max-w-full relative mt-[34px] md:mt-[48px] lg:mt-[55px] mx-auto"
          >
            <input
              class="h-full w-full rounded-[10px] bg-white text-base :placeholde-[#8A8A8A] text-[#1E1E1E] focus:outline-none pl-4 pr-[50px]"
              type="text"
              name="email"
              id="email"
            ...
            <button
              ...
              class="h-[50px] w-[50px] flex items-center justify-center rounded-[10px] absolute right-0 top-0"
              style="
                background: linear-gradient(
                  180deg,
                  #0077ed -112.22%,
...
.escape-paradise__image-slide {
  transition: 0.5s ease-in;
  transition-delay: 1s;
}

.escape-paradise__main-text {
  transition: 0.5s ease-in;
  transition-delay: 1s;
}

#escape-paradise .escape-paradise__main-text-animation {
  animation-name: escapeParadiseTextAnimation;
...
@keyframes escapeParadiseTextAnimation {
  0% {
